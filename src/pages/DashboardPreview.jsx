...
const screenshots = [
  ...
  {
    src: '/dashbaord/vehicle details.png',
  ...
  {
    src: '/dashbaord/location player.png',
    title: 'Location Playback',
    desc: 'Replay vehicle routes on a timeline. Play/pause/speed controls with up to 50K data points.',
    badge: 'Playback',
    color: '#ef4444',
  },
];
      ...
      <section className="section" style={{ background: 'var(--section-alt)' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 24 }}>
            {[
              { label: 'App Screens', value: 7, suffix: '+', color: 'var(--primary)', icon: <HiEye size={20} /> },
